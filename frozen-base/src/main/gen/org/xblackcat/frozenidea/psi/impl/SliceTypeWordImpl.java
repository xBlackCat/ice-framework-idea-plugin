...
public class SliceTypeWordImpl extends SliceCompositeElementImpl implements SliceTypeWord {

  public SliceTypeWordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitTypeWord(this);
  }
