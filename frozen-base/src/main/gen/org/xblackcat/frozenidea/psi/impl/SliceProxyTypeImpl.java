...
public class SliceProxyTypeImpl extends SliceCompositeElementImpl implements SliceProxyType {

  public SliceProxyTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitProxyType(this);
  }
