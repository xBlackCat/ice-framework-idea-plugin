...
public class SliceSequenceTypeListImpl extends SliceCompositeElementImpl implements SliceSequenceTypeList {

  public SliceSequenceTypeListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitSequenceTypeList(this);
  }
