...
public class SliceExtendsDefImpl extends SliceNamedElementImpl implements SliceExtendsDef {

  public SliceExtendsDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitExtendsDef(this);
  }
