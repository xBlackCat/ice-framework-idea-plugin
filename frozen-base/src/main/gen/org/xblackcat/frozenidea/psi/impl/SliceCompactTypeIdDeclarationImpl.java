...
public class SliceCompactTypeIdDeclarationImpl extends SliceCompositeElementImpl implements SliceCompactTypeIdDeclaration {

  public SliceCompactTypeIdDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitCompactTypeIdDeclaration(this);
  }
