...
public class SliceDictionaryDefImpl extends SliceDataTypeElementImpl implements SliceDictionaryDef {

  public SliceDictionaryDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SliceVisitor visitor) {
    visitor.visitDictionaryDef(this);
  }
  ...
  @Override
  @Nullable
  public SliceDictionaryTypeList getDictionaryTypeList() {
    return findChildByClass(SliceDictionaryTypeList.class);
  }
