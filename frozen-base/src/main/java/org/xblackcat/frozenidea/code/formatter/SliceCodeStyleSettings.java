...
public class SliceCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    /**
     * Contains value of {@link SliceCodeStyleSettings.PropertyAlignment#getId()}
     *
    ...
    public SliceCodeStyleSettings(CodeStyleSettings container) {
        super(SliceLanguage.INSTANCE.getID(), container);
    }
    ...
    public enum PropertyAlignment {
        ...
        @PropertyKey(resourceBundle = SliceBundle.BUNDLE)
