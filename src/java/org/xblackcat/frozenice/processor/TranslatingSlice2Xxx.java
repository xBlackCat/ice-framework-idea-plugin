...
public class TranslatingSlice2Xxx implements TranslatingCompiler {
    ...
    private void compileFiles(
        ...
        VirtualFile outputDir = iceFacet.getConfiguration().getConfig().getOutputDir(target);
        ...
        command.add(VfsUtil.virtualToIoFile(target.getTranslatorPath(frameworkHome)).getAbsolutePath());
